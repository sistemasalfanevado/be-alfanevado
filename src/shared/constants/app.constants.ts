...
export const BUDGET_NATURE = {
  ...
  NO_IDENTIFICADA: '221227bc-aa0b-4eb6-8d27-d4e184b0e9af',
  EXTORNO: '27e4c768-8d54-44e3-b7f5-43eed8a56c37'
};

export const BUDGET_CATEGORY = {
  INGRESO: 'f49a9464-0bf3-4e93-aa6e-221bbe344faa',
  COSTO_TIERRA: '6f4b8101-3e62-4665-910c-66bf7a0a90f2',
  OBRAS_HABILITACION_URBANA: '2770f593-6ea8-4a43-8a17-8846c69c497e',
};
...
export const MOVEMENT_STATUS = {
  CATEGORIZADO: '7b42023c-a0eb-4b80-aaaf-f22ee7a75ba4',
  NO_CATEGORIZADO: '323c52b4-6930-4074-be6f-5c2d448a0c49'
};

export const ACCOUNTABILITY_STATUS = {
  ABONO_PENDIENTE: '44c68755-aa30-4fac-b1cd-a4b74da34705',
  LIQUIDADO: '9424337e-eb71-47b5-bc3c-a29f143cb872',
  LIQUIDADO_PARCIAL: '6f0f9ac8-0838-4d05-b03c-1fa449ff75ba',
