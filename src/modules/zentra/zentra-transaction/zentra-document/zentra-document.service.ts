...
export class ZentraDocumentService {
  ...
  async createReversal(dataDocument: any) {
    ...
    return { message: 'Extorno creado correctamente' };
  }

  async removeReversal(id: string) {
    return this.removeDocumentWithMovements(id);
  }

  async findByFiltersReversal(filters: {
    projectId?: string;
    documentCategoryId?: string;
    startDate?: string;
    endDate?: string;
  ...
  async updateReversal(id: string, updateData: any) {
